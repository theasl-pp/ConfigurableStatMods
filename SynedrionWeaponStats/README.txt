...
- SynedrionWeaponStatsConfig.cs: Example of ModConfig for custom mod settings;
- SynedrionWeaponStatsGeoscape.cs: Example of ModGeoscape for modifying geoscape level;
- SynedrionWeaponStatsMain.cs: Main mod class, recieves mod management and general events;
- SynedrionWeaponStatsTactical.cs: Example of ModTactical for modifying tactical level;
