...
- NewJerichoWeaponStatsConfig.cs: Example of ModConfig for custom mod settings;
- NewJerichoWeaponStatsGeoscape.cs: Example of ModGeoscape for modifying geoscape level;
- NewJerichoWeaponStatsMain.cs: Main mod class, recieves mod management and general events;
- NewJerichoWeaponStatsTactical.cs: Example of ModTactical for modifying tactical level;
