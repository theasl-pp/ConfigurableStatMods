...
- KaosWeaponStatsConfig.cs: Example of ModConfig for custom mod settings;
- KaosWeaponStatsGeoscape.cs: Example of ModGeoscape for modifying geoscape level;
- KaosWeaponStatsMain.cs: Main mod class, recieves mod management and general events;
- KaosWeaponStatsTactical.cs: Example of ModTactical for modifying tactical level;
