...
- BionicAugmentationStatsConfig.cs: Example of ModConfig for custom mod settings;
- BionicAugmentationStatsGeoscape.cs: Example of ModGeoscape for modifying geoscape level;
- BionicAugmentationStatsMain.cs: Main mod class, recieves mod management and general events;
- BionicAugmentationStatsTactical.cs: Example of ModTactical for modifying tactical level;
