...
- AncientWeaponStatsConfig.cs: Example of ModConfig for custom mod settings;
- AncientWeaponStatsGeoscape.cs: Example of ModGeoscape for modifying geoscape level;
- AncientWeaponStatsMain.cs: Main mod class, recieves mod management and general events;
- AncientWeaponStatsTactical.cs: Example of ModTactical for modifying tactical level;
