...
- NewJerichoArmorStatsConfig.cs: Example of ModConfig for custom mod settings;
- NewJerichoArmorStatsGeoscape.cs: Example of ModGeoscape for modifying geoscape level;
- NewJerichoArmorStatsMain.cs: Main mod class, recieves mod management and general events;
- NewJerichoArmorStatsTactical.cs: Example of ModTactical for modifying tactical level;
