...
- SynedrionArmorStatsConfig.cs: Example of ModConfig for custom mod settings;
- SynedrionArmorStatsGeoscape.cs: Example of ModGeoscape for modifying geoscape level;
- SynedrionArmorStatsMain.cs: Main mod class, recieves mod management and general events;
- SynedrionArmorStatsTactical.cs: Example of ModTactical for modifying tactical level;
