...
- AnuWeaponStatsConfig.cs: Example of ModConfig for custom mod settings;
- AnuWeaponStatsGeoscape.cs: Example of ModGeoscape for modifying geoscape level;
- AnuWeaponStatsMain.cs: Main mod class, recieves mod management and general events;
- AnuWeaponStatsTactical.cs: Example of ModTactical for modifying tactical level;
