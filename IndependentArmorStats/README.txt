...
- IndependentArmorStatsConfig.cs: Example of ModConfig for custom mod settings;
- IndependentArmorStatsGeoscape.cs: Example of ModGeoscape for modifying geoscape level;
- IndependentArmorStatsMain.cs: Main mod class, recieves mod management and general events;
- IndependentArmorStatsTactical.cs: Example of ModTactical for modifying tactical level;
