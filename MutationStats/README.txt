...
- MutationStatsConfig.cs: Example of ModConfig for custom mod settings;
- MutationStatsGeoscape.cs: Example of ModGeoscape for modifying geoscape level;
- MutationStatsMain.cs: Main mod class, recieves mod management and general events;
- MutationStatsTactical.cs: Example of ModTactical for modifying tactical level;
