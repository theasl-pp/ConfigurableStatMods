...
- PhoenixWeaponStatsConfig.cs: Example of ModConfig for custom mod settings;
- PhoenixWeaponStatsGeoscape.cs: Example of ModGeoscape for modifying geoscape level;
- PhoenixWeaponStatsMain.cs: Main mod class, recieves mod management and general events;
- PhoenixWeaponStatsTactical.cs: Example of ModTactical for modifying tactical level;
