...
- IndependentWeaponStatsConfig.cs: Example of ModConfig for custom mod settings;
- IndependentWeaponStatsGeoscape.cs: Example of ModGeoscape for modifying geoscape level;
- IndependentWeaponStatsMain.cs: Main mod class, recieves mod management and general events;
- IndependentWeaponStatsTactical.cs: Example of ModTactical for modifying tactical level;
