...
- LivingWeaponStatsConfig.cs: Example of ModConfig for custom mod settings;
- LivingWeaponStatsGeoscape.cs: Example of ModGeoscape for modifying geoscape level;
- LivingWeaponStatsMain.cs: Main mod class, recieves mod management and general events;
- LivingWeaponStatsTactical.cs: Example of ModTactical for modifying tactical level;
