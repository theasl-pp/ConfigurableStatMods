...
- LivingArmorStatsConfig.cs: Example of ModConfig for custom mod settings;
- LivingArmorStatsGeoscape.cs: Example of ModGeoscape for modifying geoscape level;
- LivingArmorStatsMain.cs: Main mod class, recieves mod management and general events;
- LivingArmorStatsTactical.cs: Example of ModTactical for modifying tactical level;
