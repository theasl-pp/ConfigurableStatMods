...
- AnuArmorStatsConfig.cs: Example of ModConfig for custom mod settings;
- AnuArmorStatsGeoscape.cs: Example of ModGeoscape for modifying geoscape level;
- AnuArmorStatsMain.cs: Main mod class, recieves mod management and general events;
- AnuArmorStatsTactical.cs: Example of ModTactical for modifying tactical level;
