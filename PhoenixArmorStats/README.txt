...
- PhoenixArmorStatsConfig.cs: Example of ModConfig for custom mod settings;
- PhoenixArmorStatsGeoscape.cs: Example of ModGeoscape for modifying geoscape level;
- PhoenixArmorStatsMain.cs: Main mod class, recieves mod management and general events;
- PhoenixArmorStatsTactical.cs: Example of ModTactical for modifying tactical level;
